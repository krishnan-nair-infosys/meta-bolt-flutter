#sony embedder (flutter-wayland-clienti.bb) DPENDS on libinput, libinput needs libcheck, libcheck has rdeps on gawk, kirkstone gawk is GPLv3
#GPLv3 won't build because of not compatible license at distro level (instead of at yocto image level), solving/working around by falling back to GPLv2 version of meta-gplv2 
#taken from https://github.com/rdkcentral/meta-rdk-oss-reference/tree/develop/recipes-gplv2/gawk
